...
<!-- GENERATED from commands/create.md by scripts/gen-codex-skills.mjs — do not edit here; edit the source and re-run. -->
...
- **Capture the lesson** — a recurring review point is written into the relevant `AGENTS.md` before
  asking for another pass (see the `pr-master-postmortem` skill).
